...
(function (b, e) {
    ...
    b.fn.extend({
        propAttr: b.fn.prop || b.fn.attr, _focus: b.fn.focus, focus: function (f, g) {
    ...
    if (!b("<a>").outerWidth(1).jquery) {
        b.each(["Width", "Height"], function (h, f) {
            var g = f === "Width" ? ["Left", "Right"] : ["Top", "Bottom"], j = f.toLowerCase(), l = {
    ...
    b.extend(b.expr[":"], {
        data: b.expr.createPseudo ? b.expr.createPseudo(function (f) {
            ...
            var f = b.attr(h, "tabindex"), g = isNaN(f);
            return (g || f >= 0) && d(h, !g)
        }
    });
    b(function () {
...
(function (c, e) {
    ...
    c.widget.bridge = function (g, f) {
        c.fn[g] = function (j) {
            var h = typeof j === "string", i = Array.prototype.slice.call(arguments, 1), k = this;
            ...
            if (h) {
                this.each(function () {
                    var l = c.data(this, g), m = l && c.isFunction(l[j]) ? l[j].apply(l, i) : l;
                    if (m !== l && m !== e) {
                        k = m;
                        return false
                    }
...
(function (b, c) {
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseCapture: function (h, i) {
            ...
            var f = null, e = this, d = b(h.target).parents().each(function () {
        ...
        _mouseDrag: function (h) {
            ...
            for (var f = this.items.length - 1; f >= 0; f--) {
                var g = this.items[f], e = g.item[0], k = this._intersectsWithPointer(g);
                if (!k) {
                    continue
                }
        ...
        _intersectsWith: function (n) {
            var f = this.positionAbs.left, e = f + this.helperProportions.width, m = this.positionAbs.top,
        ...
        _intersectsWithPointer: function (f) {
            var g = (this.options.axis === "x") || b.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, f.top, f.height),
                ...
                i = g && e, d = this._getDragVerticalDirection(), h = this._getDragHorizontalDirection();
            if (!i) {
                return false
            }
        ...
        _intersectsWithSides: function (g) {
            var e = b.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, g.top + (g.height / 2), g.height),
                ...
                d = this._getDragVerticalDirection(), h = this._getDragHorizontalDirection();
            if (this.floating && h) {
                ...
                for (var g = n.length - 1; g >= 0; g--) {
                    ...
                    for (var f = o.length - 1; f >= 0; f--) {
                        ...
                        if (k && k != this && !k.options.disabled) {
                            h.push([b.isFunction(k.options.items) ? k.options.items.call(k.element[0], d, {item: this.currentItem}) : b(k.options.items, k.element), k]);
        ...
        _getScrollParent: function () {
            var d = this.options, e = d.scrollParent;
    ...
    b.extend(b.ui.sortable, {version: "@VERSION"});
    b.ui.plugin.add("sortable", "smartguides", {
        start: function (g, h) {
            var e = b(this).data("sortable"), k = e.options, j = k.tolerance;
            e.elements = [];
            e.guidesElements = [];
            ...
            function f() {
                e.elements = [];
                var l = b(window), d = l.height(), n = l.width(), i = Fai.isIE8();
                b(k.smartguides.constructor != String ? (k.smartguides.items || ":data(sortable") : k.smartguides).each(function () {
                    var s = b(this), v = s.offset(), x = this.getBoundingClientRect(),
                        u = i ? (x.bottom - x.top) : x.height, z = i ? (x.right - x.left) : x.width, A = v.top,
                        y = A + u, q = v.left, p = z + q;
                    if (b(h.item)[0] === this) {
                        return true
                    }
                    if (A >= d || y <= 0 || q >= n || p <= 0) {
                    ...
                    if (this != e.element[0]) {
                        e.elements.push({item: this, width: z, height: u, top: A, left: q})
                    }
                });
                var o = b("#g_main"), m = o[0].getBoundingClientRect();
                e.elements.push({item: o[0], width: m.width, height: m.height, top: m.top, left: m.left})
            }
            ...
            var D = b(this).data("sortable"), J = D.options, Q = J.smartTolerance, E = J.scale || 1;
            b("#absAlignTop, #absAlignRight, #absAlignBottom, #absAlignLeft, #absAlignLevel, #absAlignVertical").hide();
            ...
            var y = Fai.isIE8(), u = F.offset.left + D.margins.left, e = y ? (s.right - s.left) : s.width, q = u + e,
                n = (u + q) / 2, W = F.offset.top + D.margins.left, f = y ? (s.bottom - s.top) : s.height, V = W + f,
                T = (W + V) / 2;
            var g = [W, V], S = [W, V], k = [W, V], N = [u, q], v = [u, q], p = [u, q], w = 0, C = 0, P = 0, j = 0,
                A = 0, H = 0;
            for (var O = D.elements.length - 1; O >= 0; O--) {
                var K = D.elements[O], M = K.left, I = M + K.width, G = K.top, R = G + K.height, h = (G + R) / 2,
                    x = (M + I) / 2;
                var z = {
                    l: M,
                    r: I,
            ...
            function B(Z) {
                var aa = Z.type, an = Z.l, aj = Z.r, ah = Z.t, at = Z.b, i = Z.level, o = Z.vertical, af = Z.ls,
                    aq = Z.ls2, ap = Z.ls3, ag = Z.rs, Y = Z.rs2, X = Z.rs3, d = Z.ts, ac = Z.ts2, ab = Z.ts3,
                    ar = Z.bs, ae = Z.bs2, ad = Z.bs3, au = Z.levelS, am = Z.levelS2, al = Z.levelS3, ao = Z.verticalS,
                    ak = Z.verticalS2, ai = Z.verticalS3;
                if (af) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: an}).left - D.margins.left;
                    g.push(ah, at);
                    A = an
                }
                if (aq) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: an - e}).left - D.margins.left;
                    S.push(ah, at);
                    C = an
                }
                if (ap) {
                ...
                if (ag) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: aj}).left - D.margins.left;
                    g.push(ah, at);
                    A = aj
                }
                if (Y) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: aj - e}).left - D.margins.left;
                    S.push(ah, at);
                    C = aj
                }
                if (X) {
                ...
                if (ao) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: o}).left - D.margins.left;
                    g.push(ah, at);
                    A = o
                }
                if (ak) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: o - e}).left - D.margins.left;
                    S.push(ah, at);
                    C = o
                }
                if (ai) {
                    F.position.left = D._convertPositionTo("relative", {top: 0, left: o - e / 2}).left - D.margins.left;
                    k.push(ah, at);
                    H = o
                }
                if (d) {
                    F.position.top = D._convertPositionTo("relative", {top: ah, left: 0}).top - D.margins.top;
                    N.push(an, aj);
                    w = ah
                }
                if (ac) {
                    F.position.top = D._convertPositionTo("relative", {top: ah - f, left: 0}).top - D.margins.top;
                    v.push(an, aj);
                    j = ah
                }
                if (ab) {
                    F.position.top = D._convertPositionTo("relative", {top: ah - f / 2, left: 0}).top - D.margins.top;
                    p.push(an, aj);
                    P = ah
                }
                if (ar) {
                    F.position.top = D._convertPositionTo("relative", {top: at, left: 0}).top - D.margins.top;
                    N.push(an, aj);
                    w = at
                }
                if (ae) {
                    F.position.top = D._convertPositionTo("relative", {top: at - f, left: 0}).top - D.margins.top;
                    v.push(an, aj);
                    j = at
                }
                if (ad) {
                    F.position.top = D._convertPositionTo("relative", {top: at - f / 2, left: 0}).top - D.margins.top;
                    p.push(an, aj);
                    P = at
                }
                if (au) {
                    F.position.top = D._convertPositionTo("relative", {top: i, left: 0}).top - D.margins.top;
                    N.push(an, aj);
                    w = i
                }
                if (am) {
                    F.position.top = D._convertPositionTo("relative", {top: i - f, left: 0}).top - D.margins.top;
                    v.push(an, aj);
                    j = i
                }
                if (al) {
                    F.position.top = D._convertPositionTo("relative", {top: i - f / 2, left: 0}).top - D.margins.top;
                    p.push(an, aj);
                    P = i
                }
            }
...
(function (b, c) {
    ...
    b.extend(b.ui.draggable, {version: "@VERSION"});
    b.ui.plugin.add("draggable", "connectToSortable", {
        start: function (e, g) {
            var f = b(this).data("draggable"), h = f.options, d = b.extend({}, g, {item: f.element});
            f.sortables = [];
            ...
            var f = b(this).data("draggable"), d = b.extend({}, g, {item: f.element});
            ...
            var g = b(this).data("draggable"), d = this;
            var f = function (k) {
    ...
    b.ui.plugin.add("draggable", "cursor", {
        start: function (e, f) {
            var d = b("body"), g = b(this).data("draggable").options;
            if (d.css("cursor")) {
    ...
    b.ui.plugin.add("draggable", "opacity", {
        start: function (e, f) {
            var d = b(f.helper), g = b(this).data("draggable").options;
            if (d.css("opacity")) {
    ...
    b.ui.plugin.add("draggable", "scroll", {
        start: function (e, f) {
            ...
            var e = b(this).data("draggable"), h = e.options, d = false;
    ...
    b.ui.plugin.add("draggable", "smartguides", {
        start: function (g, h) {
            var e = b(this).data("draggable"), k = e.options, j = k.tolerance;
            e.elements = [];
            e.guidesElements = [];
            ...
            function f() {
                ...
                var o = b("#g_main"), m = o[0].getBoundingClientRect();
                e.elements.push({item: o[0], width: o.width(), height: o.height(), top: m.top, left: m.left})
            }
            ...
            var C = b(this).data("draggable"), I = C.options, P = I.tolerance, D = I.scale || 1;
            b("#absAlignTop, #absAlignRight, #absAlignBottom, #absAlignLeft, #absAlignLevel, #absAlignVertical").hide();
            var q = E.helper[0].getBoundingClientRect();
            var x = Fai.isIE8(), s = E.offset.left + C.margins.left, e = x ? (q.right - q.left) : q.width, p = s + e,
                m = (s + p) / 2, V = E.offset.top + C.margins.left, f = x ? (q.bottom - q.top) : q.height, U = V + f,
                S = (V + U) / 2;
            var g = [V, U], R = [V, U], k = [V, U], M = [s, p], u = [s, p], n = [s, p], v = 0, B = 0, O = 0, j = 0,
                z = 0, G = 0;
            for (var N = C.elements.length - 1; N >= 0; N--) {
                var J = C.elements[N], L = J.left, H = L + J.width, F = J.top, Q = F + J.height, h = (F + Q) / 2,
                    w = (L + H) / 2;
                var y = {
                    l: L,
                    r: H,
            ...
            function A(Y) {
                var Z = Y.type, am = Y.l, ai = Y.r, ag = Y.t, ar = Y.b, i = Y.level, o = Y.vertical, ae = Y.ls,
                    ap = Y.ls2, ao = Y.ls3, af = Y.rs, X = Y.rs2, W = Y.rs3, d = Y.ts, ab = Y.ts2, aa = Y.ts3,
                    aq = Y.bs, ad = Y.bs2, ac = Y.bs3, at = Y.levelS, al = Y.levelS2, ak = Y.levelS3, an = Y.verticalS,
                    aj = Y.verticalS2, ah = Y.verticalS3;
                if (ae) {
                    E.position.left = C._convertPositionTo("relative", {top: 0, left: am}).left - C.margins.left;
                    g.push(ag, ar);
                    z = am
                }
                if (ap) {
                ...
                if (af) {
                    E.position.left = C._convertPositionTo("relative", {top: 0, left: ai}).left - C.margins.left;
                    g.push(ag, ar);
                    z = ai
                }
                if (X) {
                ...
                if (an) {
                    E.position.left = C._convertPositionTo("relative", {top: 0, left: o}).left - C.margins.left;
                    g.push(ag, ar);
                    z = o
                }
                if (aj) {
                ...
                if (d) {
                    E.position.top = C._convertPositionTo("relative", {top: ag, left: 0}).top - C.margins.top;
                    M.push(am, ai);
                    v = ag
                }
                if (ab) {
                ...
                if (aq) {
                    E.position.top = C._convertPositionTo("relative", {top: ar, left: 0}).top - C.margins.top;
                    M.push(am, ai);
                    v = ar
                }
                if (ad) {
                ...
                if (at) {
                    E.position.top = C._convertPositionTo("relative", {top: i, left: 0}).top - C.margins.top;
                    M.push(am, ai);
                    v = i
                }
                if (al) {
    ...
    b.ui.plugin.add("draggable", "snap", {
        start: function (e, f) {
            var d = b(this).data("draggable"), g = d.options;
            d.snapElements = [];
            ...
            var h = b(this).data("draggable"), s = h.options;
            var z = s.snapTolerance;
            var y = q.offset.left, x = y + h.helperProportions.width, g = q.offset.top,
                f = g + h.helperProportions.height;
            for (var w = h.snapElements.length - 1; w >= 0; w--) {
                var u = h.snapElements[w].left, p = u + h.snapElements[w].width, n = h.snapElements[w].top,
                ...
                if (!((u - z < y && y < p + z && n - z < g && g < B + z) || (u - z < y && y < p + z && n - z < f && f < B + z) || (u - z < x && x < p + z && n - z < g && g < B + z) || (u - z < x && x < p + z && n - z < f && f < B + z))) {
                    if (h.snapElements[w].snapping) {
                        (h.options.snap.release && h.options.snap.release.call(h.element, v, b.extend(h._uiHash(), {snapItem: h.snapElements[w].item})))
                    }
                ...
                if (s.snapMode != "inner") {
                    ...
                    if (A) {
                        q.position.top = h._convertPositionTo("relative", {top: B, left: 0}).top - h.margins.top
                    }
                    if (k) {
                    ...
                    if (m) {
                        q.position.left = h._convertPositionTo("relative", {top: 0, left: p}).left - h.margins.left
                    }
                }
                var j = (e || A || k || m);
                if (s.snapMode != "outer") {
                    ...
                    if (e) {
                        q.position.top = h._convertPositionTo("relative", {top: n, left: 0}).top - h.margins.top
                    }
                    if (A) {
                        q.position.top = h._convertPositionTo("relative", {
                    ...
                    if (k) {
                        q.position.left = h._convertPositionTo("relative", {top: 0, left: u}).left - h.margins.left
                    }
                    if (m) {
                        q.position.left = h._convertPositionTo("relative", {
                            top: 0,
                ...
                if (!h.snapElements[w].snapping && (e || A || k || m || j)) {
                    (h.options.snap.snap && h.options.snap.snap.call(h.element, v, b.extend(h._uiHash(), {snapItem: h.snapElements[w].item})))
                }
        ...
        options: {
            ...
            this.menu = b("<ul></ul>").addClass("ui-autocomplete").appendTo(b(this.options.appendTo || "body", g)[0]).mousedown(function (h) {
                ...
                focus: function (i, j) {
                    ...
                    if (false !== e._trigger("focus", i, {item: h})) {
                        if (/^key/.test(i.originalEvent.type)) {
                            e.element.val(h.value)
                        }
                    }
                }, selected: function (j, k) {
                    var i = k.item.data("item.autocomplete"), h = e.previous;
                    ...
                    if (false !== e._trigger("select", j, {item: i})) {
            ...
            if (b.isArray(this.options.source)) {
                ...
                if (typeof this.options.source === "string") {
                    ...
                    this.source = function (i, h) {
                        ...
                        e.xhr = b.ajax({
                            url: f, data: i, dataType: "json", success: function (k, j) {
                                h(k)
                            }, error: function () {
                                h([])
                            }
...
(function (b) {
    b.widget("ui.menu", {
        _create: function () {
            ...
            this.deactivate();
            if (this.hasScroll()) {
                var g = e.offset().top - this.element.offset().top, c = this.element.scrollTop(),
            ...
            if (this.hasScroll()) {
                ...
                var f = this.active.offset().top, d = this.element.height(),
...
(function (h, i) {
    h.ui = h.ui || {};
    var e = /left|center|right/, f = /top|center|bottom/, b = "center", g = {}, c = h.fn.position, d = h.fn.offset;
    h.fn.position = function (k) {
        if (!k || !k.of) {
            return c.apply(this, arguments)
        }
        k = h.extend({}, k);
        var o = h(k.of), n = o[0], q = (k.collision || "flip").split(" "), p = k.offset ? k.offset.split(" ") : [0, 0],
            m, j, l;
        if (n.nodeType === 9) {
            m = o.width();
            j = o.height();
            ...
            if (n.setTimeout) {
                ...
                if (n.preventDefault) {
                    k.at = "left top";
                    m = j = 0;
                    l = {top: k.of.pageY, left: k.of.pageX}
                } else {
                    m = o.outerWidth();
                    j = o.outerHeight();
                    l = o.offset()
        ...
        l.top += p[1];
        return this.each(function () {
            var u = h(this), w = u.outerWidth(), t = u.outerHeight(),
                ...
                z = t + s + (parseInt(h.curCSS(this, "marginBottom", true)) || 0), x = h.extend({}, l), r;
            if (k.my[0] === "right") {
                x.left -= w
            } else {
                if (k.my[0] === b) {
            ...
            u.offset(h.extend(x, {using: k.using}))
        })
    };
    h.ui.position = {
        fit: {
            left: function (j, k) {
                var m = h(window), l = k.collisionPosition.left + k.collisionWidth - m.width() - m.scrollLeft();
                j.left = l > 0 ? j.left - l : Math.max(j.left - k.collisionPosition.left, j.left)
            }, top: function (j, k) {
                var m = h(window), l = k.collisionPosition.top + k.collisionHeight - m.height() - m.scrollTop();
            ...
            left: function (k, m) {
                ...
                var o = h(window), n = m.collisionPosition.left + m.collisionWidth - o.width() - o.scrollLeft(),
                    j = m.my[0] === "left" ? -m.elemWidth : m.my[0] === "right" ? m.elemWidth : 0,
                    l = m.at[0] === "left" ? m.targetWidth : -m.targetWidth, p = -2 * m.offset[0];
                k.left += m.collisionPosition.left < 0 ? j + l + p : n > 0 ? j + l + p : 0
            }, top: function (k, m) {
                if (m.at[1] === b) {
                    return
                }
                var o = h(window), n = m.collisionPosition.top + m.collisionHeight - o.height() - o.scrollTop(),
                    j = m.my[1] === "top" ? -m.elemHeight : m.my[1] === "bottom" ? m.elemHeight : 0,
                    l = m.at[1] === "top" ? m.targetHeight : -m.targetHeight, p = -2 * m.offset[1];
    ...
    if (!h.offset.setOffset) {
        h.offset.setOffset = function (n, k) {
            ...
            var m = h(n), p = m.offset(), j = parseInt(h.curCSS(n, "top", true), 10) || 0,
                o = parseInt(h.curCSS(n, "left", true), 10) || 0,
                l = {top: (k.top - p.top) + j, left: (k.left - p.left) + o};
            if ("using" in k) {
                k.using.call(n, l)
            } else {
                m.css(l)
    ...
    (function () {
        ...
        if (j) {
            h.extend(k, {position: "absolute", left: "-1000px", top: "-1000px"})
        }
        for (var l in k) {
            n.style[l] = k[l]
        }
...
(function (d, e) {
    d.widget("ui.resizable", d.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.handles.constructor == String) {
                ...
                for (var h = 0; h < m.length; h++) {
                    var k = d.trim(m[h]), f = "ui-resizable-" + k;
                    var j = d('<div class="ui-resizable-handle ' + f + '"></div>');
                    j.css({zIndex: l.zIndex});
                    if ("se" == k) {
            ...
            this._renderAxis = function (r) {
                ...
                for (var o in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        var p = d(this.handles[o], this.element), q = 0;
        ...
        _mouseStart: function (h) {
            var k = this.options, g = this.element.position(), f = this.element;
            this.resizing = true;
        ...
        _mouseDrag: function (f) {
            var i = this.helper, h = this.options, n = {}, r = this, k = this.originalMousePosition, p = this.axis;
            var s = (f.pageX - k.left) || 0, q = (f.pageY - k.top) || 0;
            var j = this._change[p];
            if (!j) {
                return false
            }
            var m = j.apply(this, [f, s, q]), l = d.browser.msie && d.browser.version < 7, g = this.sizeDiff;
        ...
        _mouseStop: function (i) {
            ...
            if (this._helper) {
                var h = this._proportionallyResizeElements, f = h.length && (/textarea/i).test(h[0].nodeName),
                    g = f && d.ui.hasScroll(h[0], "left") ? 0 : n.sizeDiff.height, l = f ? 0 : n.sizeDiff.width;
                var p = {width: (n.helper.width() - l), height: (n.helper.height() - g)},
                ...
                if (!j.animate) {
                    this.element.css(d.extend(p, {top: m, left: k}))
                }
        ...
        _updateRatio: function (i, h) {
            var j = this.options, k = this.position, g = this.size, f = this.axis;
            if (b(i.height)) {
        ...
        _respectSize: function (m, h) {
            var k = this.helper, j = this._vBoundaries, s = this._aspectRatio || h.shiftKey, r = this.axis,
            ...
            for (var g = 0; g < this._proportionallyResizeElements.length; g++) {
                ...
                if (!this.borderDif) {
                    ...
                    this.borderDif = d.map(f, function (m, o) {
                        var n = parseInt(m, 10) || 0, p = parseInt(k[o], 10) || 0;
                        return n + p
                    })
                }
        ...
        _renderProxy: function () {
            var g = this.element, j = this.options;
            this.elementOffset = g.offset();
            if (this._helper) {
                this.helper = this.helper || d('<div style="overflow:hidden;"></div>');
                var f = d.browser.msie && d.browser.version < 7, h = (f ? 1 : 0), i = (f ? 2 : -1);
        ...
        _change: {
            e: function (h, g, f) {
                ...
                var k = this.options, h = this.originalSize, j = this.originalPosition;
    ...
    d.extend(d.ui.resizable, {version: "@VERSION"});
    d.ui.plugin.add("resizable", "alsoResize", {
        start: function (g, h) {
            var f = d(this).data("resizable"), j = f.options;
            var i = function (k) {
                d(k).each(function () {
                    var l = d(this);
            ...
            var g = d(this).data("resizable"), k = g.options, i = g.originalSize, m = g.originalPosition;
            var l = {
                ...
                d(n).each(function () {
                    var r = d(this), s = d(this).data("resizable-alsoresize"), q = {},
    ...
    d.ui.plugin.add("resizable", "animate", {
        stop: function (j, p) {
            var q = d(this).data("resizable"), k = q.options;
            var i = q._proportionallyResizeElements, f = i.length && (/textarea/i).test(i[0].nodeName),
                g = f && d.ui.hasScroll(i[0], "left") ? 0 : q.sizeDiff.height, m = f ? 0 : q.sizeDiff.width;
            var h = {width: (q.size.width - m), height: (q.size.height - g)},
            ...
            q.element.animate(d.extend(h, n && l ? {top: n, left: l} : {}), {
                ...
                step: function () {
                    ...
                    if (i && i.length) {
                        d(i[0]).css({width: o.width, height: o.height})
                    }
                    q._updateCache(o);
    ...
    d.ui.plugin.add("resizable", "containment", {
        start: function (g, s) {
            var u = d(this).data("resizable"), k = u.options, m = u.element;
            ...
            if (/document/.test(h) || h == document) {
                ...
                u.containerSize = {height: (q.innerHeight() - j[3]), width: (q.innerWidth() - j[1])};
                var r = u.containerOffset, f = u.containerSize.height, n = u.containerSize.width,
                    i = (d.ui.hasScroll(l, "left") ? l.scrollWidth : n), t = (d.ui.hasScroll(l) ? l.scrollHeight : f);
                u.parentData = {element: l, left: r.left, top: r.top, width: i, height: t}
            }
        }, resize: function (h, r) {
            var u = d(this).data("resizable"), j = u.options, g = u.containerSize, q = u.containerOffset, n = u.size,
                p = u.position, s = u._aspectRatio || h.shiftKey, f = {top: 0, left: 0}, i = u.containerElement;
            ...
            var r = d(this).data("resizable"), i = r.options, m = r.position, n = r.containerOffset,
                f = r.containerPosition, j = r.containerElement;
            var k = d(r.helper), s = k.offset(), q = k.outerWidth() - r.sizeDiff.width,
                l = k.outerHeight() - r.sizeDiff.height;
            if (r._helper && !i.animate && (/relative/).test(j.css("position"))) {
                d(this).css({left: s.left - f.left - n.left, width: q, height: l})
            }
    ...
    d.ui.plugin.add("resizable", "ghost", {
        start: function (h, i) {
            var f = d(this).data("resizable"), j = f.options, g = f.size;
            ...
            var f = d(this).data("resizable"), i = f.options;
            if (f.ghost) {
                f.ghost.css({position: "relative", height: f.size.height, width: f.size.width})
            }
        }, stop: function (g, h) {
            var f = d(this).data("resizable"), i = f.options;
            if (f.ghost && f.helper) {
    ...
    d.ui.plugin.add("resizable", "grid", {
        resize: function (f, n) {
            var q = d(this).data("resizable"), i = q.options, l = q.size, j = q.originalSize, k = q.originalPosition,
                p = q.axis, m = i._aspectRatio || f.shiftKey;
...
(function (f, c) {
    f.extend(f.ui, {datepicker: {version: "@VERSION"}});
    var i = "datepicker";
    ...
    f.extend(g.prototype, {
        ...
        _showDatepicker: function (t) {
            ...
            var q = {left: f.datepicker._pos[0], top: f.datepicker._pos[1]};
            ...
            if (!r.inline) {
                ...
                var l = function () {
                    ...
                    if (!!x.length) {
                        ...
                        x.css({left: -w[0], top: -w[1], width: r.dpDiv.outerWidth(), height: r.dpDiv.outerHeight()})
                    }
                };
        ...
        _updateDatepicker: function (m) {
            ...
            if (!!r.length) {
                r.css({left: -n[0], top: -n[1], width: m.dpDiv.outerWidth(), height: m.dpDiv.outerHeight()})
            }
        ...
        _getBorders: function (k) {
            var l = function (m) {
                return {thin: 1, medium: 2, thick: 3}[m] || m
            };
...
(function (b, c) {
    ...
    b.extend(b.ui.droppable, {version: "@VERSION"});
    b.ui.intersect = function (s, k, p) {
        if (!k.offset) {
            return false
        }
        var f = (s.positionAbs || s.position.absolute).left, e = f + s.helperProportions.width,
            o = (s.positionAbs || s.position.absolute).top, n = o + s.helperProportions.height;
    ...
    b.ui.ddmanager = {
        current: null, droppables: {"default": []}, prepareOffsets: function (g, k) {
...
(function (e, g) {
    ...
    e.widget("ui.tabs", {
        options: {
            ...
            var w = this, k = this.options, p = k.version == 2 ? true : false, j = /^#.+/;
            ...
            this.anchors.bind(k.event + ".tabs", function () {
                var o = this, y = e(o).closest("li"), i = w.panels.filter(":not(.ui-tabs-hide)"),
            ...
            var p = this, j = this.options, k = j.version == 2 ? true : false,
            ...
            h = this._getIndex(h);
            var j = this.options, k = this.lis.eq(h).remove(), i = this.panels.eq(h).remove();
            ...
            k = this._getIndex(k);
            var i = this, m = this.options, h = this.anchors.eq(k)[0], j = e.data(h, "load.tabs");
            this.abort();
    ...
    e.extend(e.ui.tabs, {version: "@VERSION"});
    e.extend(e.ui.tabs.prototype, {
        rotation: null, rotate: function (j, l) {
...
(function (b) {
    ...
    b.Marquee = function (f, r) {
        ...
        var p = this, n = b(f), g = n.find("> li"), i = -1, h = false, m = false, o = 0;
        ...
        function l(s) {
            ...
            var t = {top: (r.yScroll == "top" ? "-" : "+") + u.outerHeight() + "px", left: 0};
            n.data("marquee.showing", true);
            u.addClass(r.cssShowing);
            u.css(t).animate({top: "0px"}, r.showSpeed, r.fxEasingShow, function () {
        ...
        function k(t, s) {
            ...
            if (d(t)) {
                setTimeout(function () {
                    ...
                    var w = t.outerWidth(), u = w * -1, v = parseInt(t.css("left"), 10);
                    t.animate({left: u + "px"}, ((w + v) * r.scrollSpeed), r.fxEasingScroll, function () {
                        j(t)
                    })
                }, s)
            } else {
                if (g.length > 1) {
                    ...
                    n.data("timeout", setTimeout(function () {
                        ...
                        t.animate({top: (r.yScroll == "top" ? "+" : "-") + n.data("_innerHeight") + "px"}, r.showSpeed, r.fxEasingScroll);
                        j(t)
                    }, s))
                }
            }
        ...
        function q() {
            ...
            if (r.hoverChange && g.length > 1) {
                ...
                b("body").append(s);
                s.offset({top: n.offset().top - 1, left: n.offset().left});
                b("body").append(t);
                t.offset({top: n.offset().top - 1, left: (n.offset().left + n.width() - 1)})
            }
        }
        ...
        imageSwitch: function (d) {
            ...
            return b(this).each(function () {
                ...
                b.each(c.data, function (N, K) {
                    ...
                    S += "'";
                    var L = b('<a hidefocus="true" style="outline:none;" ' + S + "/>").css({
                        width: q,
                        height: g + "px",
                        ...
                        id: "photoList" + (K.pic || N),
                        href: K.href ? K.href : "javascript:;",
                        target: K.target ? K.target : "",
                        title: K.tip ? K.tip : ""
                    }).appendTo(h);
                    var R = {width: K.width, height: K.height};
                    if (K.width && K.width > 0) {
                        L.html("<img src='" + Fai.transforThumbpath(K.src, R) + "' width='" + K.width + "' height='" + K.height + "' alt='" + K.name + "'>")
                    } else {
                        L.css("background-image", "url(" + K.src + ")")
                    }
                    if (c.btnType == 1) {
                        var M = b('<a class="imageSwitchBtn" />').appendTo(C).html("<span>" + (N + 1) + "</span>")
                    } else {
                        if (c.btnType == 2) {
                            var M = b('<a class="imageSwitchBtn_dot" />').appendTo(C)
                        }
                    }
                    var O = b('<span class="spanHiddenName"/>').appendTo(s).css("margin-left", 10 + "px").html(Fai.encodeHtml(K.name));
                    if (c.btnType != 0) {
                        if (N == e) {
                            if (c.btnType == 1) {
                ...
                if (J > 1) {
                    if (c.btnType != 0) {
                        r.click(function (L) {
                            ...
                            switch (c.animateStyle) {
                                case"o":
                                    ...
                                    break;
                                case"x":
                                    h.animate({marginLeft: -K * E}, c.animateTime);
                                    break;
                                case"y":
                                    h.animate({marginTop: -K * g}, c.animateTime);
                                    break;
                                case"show":
                                case"show-x":
                                case"show-y":
                            ...
                            if (M) {
                                M.css({width: c.data[K].imgWidth, left: (A.width() - c.data[K].imgWidth) / 2 + "px"});
                                M.css({height: c.data[K].imgHeight, top: (A.height() - c.data[K].imgHeight) / 2 + "px"})
                            }
                        });
                        ...
                        function B(K) {
                            ...
                            x.eq(++n).addClass("spanShowName");
                            Fai.top.$("#arrowImg" + n).css({left: q});
                            Fai.top.$(".arrowImg").animate({left: "-=" + F}, 1000);
                            var L = Fai.top.$("#bannerGetHref");
                            if (L) {
                                L.css({width: c.data[n].imgWidth, left: (A.width() - c.data[n].imgWidth) / 2 + "px"});
                                L.css({height: c.data[n].imgHeight, top: (A.height() - c.data[n].imgHeight) / 2 + "px"})
                            }
                            setTimeout(function () {
                                Fai.startInterval(I)
                            }, 300)
    ...
    c.fn.CloudZoom = function (f) {
        ...
        this.each(function () {
            ...
            if (c(this).is(".cloud-zoom")) {
                c(this).css({position: "relative", display: "block"});
                c("img", c(this)).css({display: "block"});
...
var JPlaceHolder = {
    _check: function () {
        ...
        jQuery(":input[placeholder]").each(function (e, b) {
            var l = $(this), c = l.attr("placeholder");
            var g = l.position(), d = l.outerHeight(true), i = l.outerWidth(true), k = l.css("padding-left"),
                j = l.css("padding-top");
            var j = parseInt(d / 4);
...
(function (b) {
    ...
    b.datepicker._gotoToday = function (j) {
        var g = this._getInst(b(j)[0]), i = g.dpDiv;
...
(function (g, l, n, e) {
    var k = "stellar", f = {
        ...
        }()), j = b("transform"), d = g("<div />", {style: "background:#fff"}).css("background-position-x") !== e,
        c = (d ? function (r, q, s) {
            r.css({"background-position-x": q, "background-position-y": s})
        } : function (r, q, s) {
    ...
    p.prototype = {
        init: function () {
            ...
            var q = this, r = h[q.options.scrollProperty];
            ...
            var q = this, t = h[q.options.scrollProperty], r = m[q.options.positionProperty], s = t.setLeft,
                u = t.setTop;
            ...
            var r = this, t = r._getScrollLeft(), q = r._getScrollTop();
            if (!s || !s.firstLoad) {
                this._reset()
            }
            ...
            if (s && s.firstLoad && /WebKit/.test(navigator.userAgent)) {
                g(l).load(function () {
                    var v = r._getScrollLeft(), u = r._getScrollTop();
            ...
            var r = this.$viewportElement.offset(), q = r !== null && r !== e;
            this.viewportWidth = this.$viewportElement.width();
            this.viewportHeight = this.$viewportElement.height();
            this.viewportOffsetTop = (q ? r.top : 0);
            this.viewportOffsetLeft = (q ? r.left : 0)
        }, _findParticles: function () {
            var q = this, t = this._getScrollLeft(), s = this._getScrollTop();
            if (this.particles !== e) {
            ...
            var w = this._getScrollLeft(), t = this._getScrollTop(), C, G, B, F, r, E, x, v = true, q = true, A, D, u,
                s, z, y = 0;
            ...
            if (this.$viewportElement && this.$viewportElement.hasClass("g_main")) {
                y = this.$viewportElement.offset().top
            }
            for (z = this.backgrounds.length - 1; z >= 0; z--) {
                ...
                x = (this.options.verticalScrolling ? (t + r.verticalOffset - this.viewportOffsetTop - r.startingOffsetTop + r.parentOffsetTop - r.startingBackgroundPositionTop) * (F - r.stellarRatio) + y + "px" : r.startingValueTop);
                c(r.$element, E, x)
            }
...
jQuery.effects || (function (i, f) {
    ...
    function h() {
        var r = document.defaultView ? document.defaultView.getComputedStyle(this, null) : this.currentStyle, s = {}, p,
            q;
    ...
    i.effects.animateClass = function (o, p, r, q) {
        ...
        return this.queue(function () {
            ...
            v.attr("class", t);
            v.animate(j(w, u), {
                queue: false, duration: p, easing: r, complete: function () {
                    i.each(g, function (x, y) {
                        if (o[y]) {
                            v[y + "Class"](o[y])
                        }
    ...
    i.fn.extend({
        _addClass: i.fn.addClass, addClass: function (p, o, r, q) {
            return o ? i.effects.animateClass.apply(this, [{add: p}, o, r, q]) : this._addClass(p)
        }, _removeClass: i.fn.removeClass, removeClass: function (p, o, r, q) {
            return o ? i.effects.animateClass.apply(this, [{remove: p}, o, r, q]) : this._removeClass(p)
        }, _toggleClass: i.fn.toggleClass, toggleClass: function (q, p, o, s, r) {
            if (typeof p == "boolean" || p === f) {
                if (!o) {
                    return this._toggleClass(q, p)
                } else {
                    return i.effects.animateClass.apply(this, [(p ? {add: q} : {remove: q}), o, s, r])
                }
            } else {
                return i.effects.animateClass.apply(this, [{toggle: q}, p, o, s])
            }
        }, switchClass: function (o, q, p, s, r) {
            return i.effects.animateClass.apply(this, [{add: q, remove: o}, p, s, r])
        }
    });
    i.extend(i.effects, {
        version: "@VERSION", save: function (p, q) {
            ...
            var p = {width: o.outerWidth(true), height: o.outerHeight(true), "float": o.css("float")},
            ...
            if (o.css("position") == "static") {
                ...
                i.extend(p, {position: o.css("position"), zIndex: o.css("z-index")});
    ...
    i.fn.extend({
        effect: function (r, q, t, v) {
            var p = e.apply(this, arguments), s = {options: p[1], duration: p[2], callback: p[3]}, u = s.options.mode,
                o = i.effects[r];
            if (i.fx.off || !o) {
                if (u) {
        ...
        }, _show: i.fn.show, show: function (p) {
            if (m(p)) {
        ...
        }, _hide: i.fn.hide, hide: function (p) {
            if (m(p)) {
        ...
        }, __toggle: i.fn.toggle, toggle: function (p) {
...
(function (g) {
    ...
    g.extend(g.ui, {timepicker: {version: "1.0.5"}});
    ...
    g.extend(c.prototype, {
        ...
        _newInst: function (r, j) {
            ...
            p._defaults = g.extend({}, this._defaults, n, j, s, {evnts: u, timepicker: p});
            ...
            p.$input = r;
            if (j.altField) {
                p.$altInput = g(j.altField).css({cursor: "pointer"}).focus(function () {
                    r.trigger("focus")
                })
            }
        ...
        _injectTimePicker: function () {
            var w = this.inst.dpDiv, z = this.inst.settings, k = this, u = "", n = "", E = {}, r = {}, x = null;
            if (w.find("div.ui-timepicker-div").length === 0 && z.showTimepicker) {
                ...
                for (var F = 0, B = k.units.length; F < B; F++) {
                    ...
                    if (z["show" + n] && z[u + "Grid"] > 0) {
                        ...
                        j.find(".ui_tpicker_" + u + " table").css({
                            ...
                            var J = g(this), l = J.html(), o = J.data("for");
                            if (o == "hour" && z.ampm) {
                                var i = l.substring(2).toLowerCase(), m = parseInt(l.substring(0, 2), 10);
                                if (i == "a") {
                                    if (m == 12) {
                                        l = 0
                                    } else {
                            ...
                            k._onTimeChange();
                            k._onSelectHandler()
                        }).css({cursor: "pointer", width: (100 / r[u]) + "%", textAlign: "center", overflow: "hidden"})
                    }
                }
                ...
                if (this._defaults.addSliderAccess) {
                    var C = this._defaults.sliderAccessArgs, q = this._defaults.isRTL;
                    C.isRTL = q;
                    setTimeout(function () {
                        if (j.find(".ui-slider-access").length === 0) {
                            ...
                            if (i) {
                                j.find("table:visible").each(function () {
                                    var m = g(this), l = m.outerWidth(),
                                        K = m.css(q ? "marginRight" : "marginLeft").toString().replace("%", ""),
                                        J = l - i, I = ((K * J) / l) + "%",
                                        o = {width: J, marginRight: 0, marginLeft: 0};
        ...
        _limitMinMaxDateTime: function (s, t) {
            var j = this._defaults, q = new Date(s.selectedYear, s.selectedMonth, s.selectedDay);
            ...
            if (t !== undefined && t === true) {
                ...
                if (this.hour_slider) {
                    this.control.options(this, this.hour_slider, {min: this._defaults.hourMin, max: m});
                    this.control.value(this, this.hour_slider, this.hour)
                }
                if (this.minute_slider) {
                    this.control.options(this, this.minute_slider, {min: this._defaults.minuteMin, max: n});
                    this.control.value(this, this.minute_slider, this.minute)
                }
                if (this.second_slider) {
                    this.control.options(this, this.second_slider, {min: this._defaults.secondMin, max: p});
                    this.control.value(this, this.second_slider, this.second)
                }
                if (this.millisec_slider) {
                    this.control.options(this, this.millisec_slider, {min: this._defaults.millisecMin, max: k});
        ...
        _onTimeChange: function () {
            var i = (this.hour_slider) ? this.control.value(this, this.hour_slider) : false,
                ...
                n = (this.timezone_select) ? this.timezone_select.val() : false, p = this._defaults;
            if (typeof(i) == "object") {
                i = false
            }
            if (typeof(q) == "object") {
        ...
        _updateDateTime: function (o) {
            ...
            var j = g.datepicker._daylightSavingAdjust(new Date(o.selectedYear, o.selectedMonth, o.selectedDay)),
                p = g.datepicker._get(o, "dateFormat"), k = g.datepicker._getFormatConfig(o),
        ...
        _onFocus: function () {
            if (!this.$input.val() && this._defaults.defaultValue) {
                ...
                var k = g.datepicker._getInst(this.$input.get(0)), i = g.datepicker._get(k, "timepicker");
                if (i) {
            ...
            slider: {
                ...
                create: function (r, q, u, k, o, t, l) {
                    var j = '<select class="ui-timepicker-select" data-unit="' + u + '" data-min="' + o + '" data-max="' + t + '" data-step="' + l + '">',
                        s = r._defaults.timeFormat.indexOf("t") !== -1 ? "toLowerCase" : "toUpperCase", n = 0;
                    for (var p = o; p <= t; p += l) {
                ...
                create: function (r, q, u, k, o, t, l) {
                    var j = '<div class="fk-timepicker-time" data-unit="' + u + '" data-min="' + o + '" data-max="' + t + '" data-step="' + l + '">',
                        v = r.inst.settings.beforeShowTime,
                        s = r._defaults.timeFormat.indexOf("t") !== -1 ? "toLowerCase" : "toUpperCase", n = 0, w;
                    ...
                    q.find(".fk-timepicker-time").off("click.time").on("click.time", function (y) {
                        var x = g(this), m = g(this).find(".fk-timeVauleWrap"),
                    ...
                    var l = {}, n = k.children(".fk-timepicker-time");
                    if (typeof(j) == "string") {
                        if (m === undefined) {
                            return n.data(j)
                        }
    ...
    g.datepicker.parseTime = function (p, i, u) {
        ...
        var q = {hour: 0, minute: 0, second: 0, millisec: 0};
        if (s) {
            if (m.t !== -1) {
    ...
    g.datepicker.formatTime = function (m, l, k) {
        ...
        l = g.extend({hour: 0, minute: 0, second: 0, millisec: 0, timezone: "+0000"}, l);
        var n = m;
        var j = k.amNames[0];
    ...
    g.datepicker._selectDate = function (l, i) {
        var k = this._getInst(g(l)[0]), j = this._get(k, "timepicker");
        if (j) {
    ...
    g.datepicker._doKeyPress = function (n) {
        var o = g.datepicker._getInst(n.target), l = g.datepicker._get(o, "timepicker");
        if (l) {
            if (g.datepicker._get(o, "constrainInput")) {
                var k = l._defaults.ampm, j = g.datepicker._possibleChars(g.datepicker._get(o, "dateFormat")),
    ...
    g.datepicker._updateAlternate = function (o) {
        ...
        if (p) {
            ...
            if (i) {
                var m = p._defaults.altFormat || p._defaults.dateFormat, j = this._getDate(o),
                    k = g.datepicker._getFormatConfig(o), q = "",
    ...
    g.datepicker._doKeyUp = function (k) {
        var l = g.datepicker._getInst(k.target), i = g.datepicker._get(l, "timepicker");
        if (i) {
    ...
    var e = function (k, j, q, r) {
        try {
            var p = r && r.separator ? r.separator : g.timepicker._defaults.separator,
                ...
                s = r && r.ampm ? r.ampm : g.timepicker._defaults.ampm, u = v.split(p), n = u.length, m = j.split(p),
                o = m.length;
            if (!s) {
            ...
            if (l.indexOf(":") >= 0) {
                var t = j.length - (l.length - l.indexOf(":") - 2), i = j.substring(t);
    ...
    var d = function (k, m, j, n, p) {
        ...
        if (o[1] !== "") {
            var i = o[1], q = g.datepicker.parseTime(m, i, p);
            if (q === null) {
                throw"Wrong time format"
            }
            return {date: l, timeObj: q}
        } else {
            return {date: l}
        }
    };
    ...
    g.timepicker.timeZoneOffsetString = function (j) {
        var l = j.getTimezoneOffset() * -1, k = l % 60, i = (l - k) / 60;
    ...
    g.timepicker.handleRange = function (n, l, i, j) {
        ...
        if (n != "timepicker" && j.reformat) {
            g([l, i]).each(function () {
                var p = g(this)[n].call(g(this), "option", "dateFormat"), o = new Date(g(this).val());
                if (g(this).val() && o) {
