...
(function (d, f, e) {
        ...
        switch (s) {
            case 2:
                ...
                if (j) {
                    ...
                    if (j == 2 || j == 4) {
                        if (m > t) {
                            d(w).css({height: t - 2 + "px", width: t - 2 * g + "px"})
                        } else {
                            d(w).css({height: m - 2 * g + "px", width: m - 2 * g + "px"})
                        }
                    }
                    if (j == 1 || j == 3) {
                        d(w).css({height: m - 2 * g + "px", width: t - 2 * g + "px"})
                    }
                }
                break;
            case 3:
    ...
    function b(t, m) {
        ...
        if (r == 5) {
            ...
            d(t).css({height: i + "px", bottom: "-" + i + "px", left: s + k + "px"})
        }
        d(t).attr("fk_fixed", 1)
    }
    ...
    function c(j, s, A) {
        ...
        var B, q, w;
        if (t == 4) {
            var h = d(A).parent(), o = -parseInt(d(A).css("marginLeft").replace("px", "")) || 0;
            cardDivMT = -parseInt(d(A).css("marginTop").replace("px", "")) || 0;
            d(j).css({width: h.width() + "px", height: h.height() + "px", left: o + "px", top: cardDivMT + "px"});
            ...
            if (t == 5) {
                ...
                q = d(B).width();
                w = d(B).height();
                var m = d(B).css("margin-left"), l = parseFloat(d(A).css("margin-left").replace("px", ""));
                var m = f.FUNC.TOOL.parsePixelToInt(m);
                d(j).removeClass("imageEffectsAnimate").addClass("imageEffectsAnimate_Half");
                d(j).css("width", q);
                var g = d(n).height(), n = d(j).find(".props .propList"), v = d(j).find(".props .propBuy"),
                    g = d(n).height(), x = parseInt(d(n).css("padding-top")), p = parseInt(d(n).css("margin-bottom")),
...
(function (f, h, g) {
    h.FUNC.BASIC.Init = function (q) {
        ...
        if (j == 8) {
            ...
            f(p).off("mouseenter.imageEffectPlugs mouseleave.imageEffectPlugs").on("mouseenter.imageEffectPlugs mouseleave.imageEffectPlugs", function (t) {
    ...
    function b(i, Q) {
        ...
        var v = {
            ...
            z = Q[h.DATA.KEY.OPT_IMG_EFF_OPTION][h.DATA.KEY.HALF_MASK_BG_STYLE], L = {
            ...
            }, K = {color: "#555555", opacity: 80}, k = {color: "#000", opacity: 85};
        ...
        if (j.effType == 6) {
            ...
            if (!!j.spScaleUp) {
                if (!n.hasClass("J_spScaleUp")) {
                    ...
                    n.append(m);
                    n.find(".J_spScaleUp").append(f(l)).css({width: q, height: p})
                }
            } else {
                if (n.hasClass("J_spScaleUp")) {
                    n.parent().append(f(l));
