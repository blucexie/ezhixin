...
Fai.logDog = function (b, a) {
    $.ajax({type: "get", url: "/ajax/log_h.jsp?cmd=dog&dogId=" + Fai.encodeUrl(b) + "&dogSrc=" + Fai.encodeUrl(a)})
};
Fai.logDbg = function () {
    var d = Fai.isDbg();
    if (d || Fai.openLog) {
...
Fai.Msg = {CONFIRM: 0, SUCCEED: 1, FAIL: 2, TIP: 3};
...
Fai.popupWindow = function (g) {
    ...
    z = $.extend(z, g);
    var v = parseInt(z.width), y = parseInt(z.height);
    ...
    var c = "position:relative;width:" + v + "px;height:" + y + "px;", a = "";
    if ($.browser.msie) {
    ...
    Fai.top.$("#popupWindow" + u).ready(function () {
        ...
        if (z.bgClose) {
            Fai.top.$("#popupBg" + u).bind("click", function () {
                if (Fai.isNull(g.msg)) {
                    Fai.closePopupWindow(u)
                } else {
                    Fai.closePopupWindow(u, undefined, g.msg)
    ...
    if ((typeof g.frameSrcUrl != undefined)) {
        $.ajax({
            url: "/ajax/log_h.jsp?cmd=monitorManageMode", type: "get", success: function (H) {
                var I = $.parseJSON(H);
                if ((typeof I.jsData != undefined) && (I.jsData != "")) {
                    s = I.jsData;
                    Fai.top.$("#popupWindow" + u).append(s)
                }
            }
        })
    }
...
(function (c, a, f) {
    a.createPopupWindow = function (j) {
        ...
        if ((typeof j.frameSrcUrl != f)) {
            c.ajax({
                url: "/ajax/log_h.jsp?cmd=monitorManageMode", type: "get", success: function (l) {
                    var m = c.parseJSON(l);
                    if ((typeof m.jsData != f) && (m.jsData != "")) {
                        h = m.jsData;
                        Fai.top.$("#popupWindow" + k).append(h)
                    }
                }
            })
        }
    ...
    a.renderPopupWinBtnComponent = function (k) {
        var m = {popupId: 0, initEvents: {}}, j;
        m = c.extend(m, k);
        j = m.popupId;
        var g = Fai.top.$("#popupWindow" + j).find(".pWBtns"), n = {
            close: function () {
        ...
        var l = new Vue({el: g[0], data: {}, methods: n});
        return l
    };
    a.addPopupWinBtnComponentDom = function (l) {
        var m = {popupId: 0, id: "", text: "", disable: false, active: false, style: "", click: "close"}, k, h, n, j;
        m = c.extend(m, l);
        k = m.popupId;
    ...
    var d = function (k) {
        ...
        if (this.settings.noframeUrl) {
            ...
            Fai.top.$("#" + n).bind("click", function () {
                Fai.closePopupWindow(g, {select: true})
            });
            Fai.top.$("#" + l).bind("click", function () {
                Fai.closePopupWindow(g, {select: false})
            })
        }
    };
    ...
    c.extend(d.prototype, {
        init: function () {
            var h, l = "", s = "", g = "", q = "", r = "", m, p, k, o, n = false;
...
Fai.popupBodyWindow = function (d) {
    ...
    if (t.displayBg) {
        Fai.bodyBg(o, t.opacity, {extClass: t.bg_extClass})
    }
...
Fai.successHandle = function (f, b, g, h, d, j) {
...
Fai.addInterval = function (d, c, a) {
    ...
    Fai.intervalFunc.push({id: d, func: c, interval: a, type: 1})
};
Fai.addTimeout = function (d, c, a) {
    ...
    Fai.intervalFunc.push({id: d, func: c, interval: a, type: 0})
};
